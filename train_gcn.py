...
# --------------------------------------------
OUTPUT_DIR = config.get("output_directory", "training_results_gcn")
...
# --------------------------------------------
# wandb.init(project="gcn_hyperparam_tuning", config=params)
# params = wandb.config
...
def train_model(model, optimizer, early_stopping, train_loader, val_loader, test_loader, fold_idx=None):
    ...
    model_filename = f"gcn_{mode}_{mask_strategy}_{evidence_type}{log_suffix}{fold_suffix}.pt"
